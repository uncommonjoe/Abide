...
const Scripture = ({ reading, loading }) => {
  ...
  const getPassageText = async () => {
    ...
    try {
      ...
      const verseStyle = reactStringReplace(noBrackets, /(\d+)/g, (match) => (
        <Text
          style={{
            fontSize: 14,
  ...
  return (
    <View>
      ...
      <Text style={styles.copywriteText}>
        ESV® Bible (The Holy Bible, English Standard Version®), copyright © 2001
        by Crossway, a publishing ministry of Good News Publishers. Used by
        permission. All rights reserved. The Holy Bible, English Standard
        ...
        Churches of Christ in the U.S.A. All rights reserved. For information on
        how the ESV can be quoted, please visit our permission site
