            ...
            return (
              <View>
                <TouchableOpacity
                  key={item}
                  activeOpacity={1}
                  onPress={() => selectReading(item, index, setHeaderTitle)}
                  style={[styles.button, buttonStyle(item.reading)]}
                >
                ...
                <View style={[styles.button, buttonStyle(item.reading)]}>
                  <CircleCheck
                    isComplete={item.isComplete}
                    color={"white"}
                    readingObj={item}
                    onChange={(isComplete) => onChange(isComplete, index, item)}
                  />
                </View>
              </View>
            );
